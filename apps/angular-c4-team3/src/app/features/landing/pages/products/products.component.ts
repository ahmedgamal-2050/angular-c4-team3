...
import { LucideAngularModule, Image as ImageIcon, Gift, Flower2, Star } from 'lucide-angular';
...
@Component({
  ...
  imports: [ProductCardComponent, LucideAngularModule, RatingModule, InputTextModule, FormsModule, PaginatorModule, ProductFiltersComponent],
...
export class ProductsComponent implements OnInit, OnDestroy {
  ...
  paginatorClass = signal<string>('p-2! border! dark:border-none! border-zinc-100! rounded-lg! size-8! dark:bg-zinc-700!');
